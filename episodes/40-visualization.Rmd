...
```{r log-transfo, cache=FALSE, purl=TRUE, fig.alt="Histogram produced by ggplot() and geom_histogram() for the log of expression."}
rna <- rna |>
...
```{r second-ggplot, cache=FALSE, purl=TRUE, fig.alt="Histogram produced by ggplot() and geom_histogram() for the log of expression."}
...
```{r, eval=TRUE, purl=TRUE, echo=TRUE, fig.alt="Histograms produced by ggplot(), geom_histogram() and scale_x_log10() for the log of expression."}
ggplot(data = rna,mapping = aes(x = expression))+
  geom_histogram() +
  scale_x_log10()
```
