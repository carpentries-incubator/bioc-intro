...
will see how to organize data into tables in a standardized way to
...
where data is repeatedly tranformed, visualized, modelled. This
...
preparing the data, rather than actually analyzing and understanding
it.

An agile data analysis workflow, with several fast iterations of the
transform/visualize/model cycle is only feasible is the data is
